...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  for (var i = 0; i < data1.length; i++) {
    ...
    if (data1[i].type === 'debit') {
      tableData.debit = data1[i].amount.toLocaleString('id');
    ...
    if (data1[i].type === 'credit') {
      tableData.kredit = data1[i].amount.toLocaleString('id');
...
//# sourceMappingURL=dashboard.js.e332993cb540a2fb2119.hot-update.js.map